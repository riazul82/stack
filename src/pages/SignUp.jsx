                ...
                <div className="py-[120px] w-[540px] h-auto">
                    ...
                    <form className="w-full h-auto" onSubmit={handleSubmit}>
                        <div className={`mt-[30px] flex items-center justify-start h-[58px] w-full rounded-[16px] outline-none border ${!validEmail ? 'border-[#FF5630]' : 'border-[#C6CCD4]'}`}>
                            ...
                            <input value={user.email} onChange={handleChange} className="font-medium text-[16px] text-[#8A94A6] h-full w-full border-none outline-none focus:ring-transparent rounded-[16px] px-[13px] placeholder-[#B0B7C3]" type="text" name="email" placeholder="Your Email" formnovalidate="formnovalidate"  />
                        </div>
