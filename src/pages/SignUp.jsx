            ...
            <div className="flex justify-center w-full mb-[70px]">
                <div className="py-[120px] w-[540px] h-auto">
                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex justify-center items-center w-[255px] h-[58px] mt-[30px] bg-[#F0F5FA] rounded-[16px]">
                    ...
                    <form className="w-full h-auto" action="#">
                        <div className="mt-[30px] flex items-center justify-start h-[58px] w-full rounded-[16px] outline-none border border-[#C6CCD4]">
                            ...
                            <input className="font-medium text-[16px] text-[#B0B7C3] h-full w-full border-none outline-none focus:ring-transparent rounded-[16px] px-[13px] placeholder-[#B0B7C3]" type="text" placeholder="Your Email" />
                        </div>
                        ...
                        <div className="mt-[30px] flex items-center justify-start h-[58px] w-full rounded-[16px] outline-none border border-[#C6CCD4]">
                            ...
                            <input className="font-medium text-[16px] text-[#B0B7C3] h-full w-full border-none outline-none focus:ring-transparent rounded-[16px] px-[13px] placeholder-[#B0B7C3]" type="text" placeholder="Your Name" />
                        </div>

                        <div className="mt-[30px] relative flex items-center justify-start h-[58px] w-full rounded-[16px] outline-none border border-[#C6CCD4]">
                            <div className="flex items-center h-full pl-[18px]">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <input className="font-medium text-[16px] text-[#B0B7C3] h-full w-full border-none outline-none focus:ring-transparent rounded-[16px] px-[13px] placeholder-[#B0B7C3]" type="text" placeholder="Create Password" />
                            <div className="pr-[18px]">
                                <BsFillEyeFill className="text-[#C1C7D0] text-[20px]" />
                            </div>
                        </div>
                        ...
                        <div class="flex items-center mt-[30px]">
                            <input id="default-checkbox" type="checkbox" value="" class="w-[28px] h-[28px] text-[#38CB89] bg-gray-100 border-gray-300 rounded focus:ring-transparent focus:ring-0" />
                            <label for="default-checkbox" class="ml-[17px] text-[16px] font-medium text-[#B0B7C3]">I agree to the Terms & Conditions</label>
                        </div>
                    ...
                    <div className="mt-[35px] flex justify-center items-center">
                        ...
                        <Link to="/signin" className="ml-1 text-[16px] text-[#377DFF] font-medium">Sign In</Link>
                    </div>
                </div>
            </div>
        </AuthLayout>
